...
void do_fmt_1() {
  ...
  case 5:
    ...
    do_each("XCT");
    tmp = regs.PS.I2;
    getAMword((unsigned char *)&regs.PC, regs.SP);
    regs.SP += 2;
    getAMword((unsigned char *)&regs.PS, regs.SP);
    regs.SP += 2;

    getAMword((unsigned char *)&newop, regs.PC);
    if ((newop > 3) && (newop < 8)) /* HALT, XCT, BPT, or WFI */
                                    /* ???? */
    {
      regs.PC += 2; /* and stacked PS should be smashed too */
      regs.SP -= 2;
      putAMword((unsigned char *)&regs.PC, regs.SP);
      regs.SP -= 2;
      putAMword((unsigned char *)&regs.PC, regs.SP);
      getAMword((unsigned char *)&regs.PC, 0x1E);
      regs.PS.I2 = 0;
      ...
      regs.SP -= 2;
      putAMword((unsigned char *)&regs.PC, regs.SP);
      getAMword((unsigned char *)&regs.PC, 0x20);
    }
    break;
  case 6:
    //      BPT             BREAKPOINT TRAP
    ...
    regs.SP -= 2;
    putAMword((unsigned char *)&regs.PC, regs.SP);
    getAMword((unsigned char *)&regs.PC, 0x2C);
    break;
  case 7:
  ...
  case 8:
    ...
    //
    do_each("RSVC");
    getAMword((unsigned char *)&regs.R0, regs.SP);
    regs.SP += 2;
    getAMword((unsigned char *)&regs.R1, regs.SP);
    regs.SP += 2;
    getAMword((unsigned char *)&regs.R2, regs.SP);
    regs.SP += 2;
    getAMword((unsigned char *)&regs.R3, regs.SP);
    regs.SP += 2;
    getAMword((unsigned char *)&regs.R4, regs.SP);
    regs.SP += 2;
    getAMword((unsigned char *)&regs.R5, regs.SP);
    regs.SP += 2;
    regs.SP += 2;
    getAMword((unsigned char *)&regs.PC, regs.SP);
    regs.SP += 2;
  ...
  case 11:
    ...
    //      INDICATORS:     Unchanged
    //
    getAMword((unsigned char *)&mask, regs.PC);
    regs.PC += 2;
    ...
    regs.SP -= 2;
    putAMword((unsigned char *)&oldmask, regs.SP);
  ...
  case 14:
    ...
    //
    do_each("RSTS");
    getAMword((unsigned char *)&mask, regs.SP);
    regs.SP += 2;
